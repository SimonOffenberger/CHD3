...
-- GPIO_0[2]	=>  Location: PIN_AD17,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: Default
...
SIGNAL \AllMpx|MpxUsingIf|oY~2_combout\ : std_logic;
...
SIGNAL \AllMpx|MpxUsingIf|oY~1_combout\ : std_logic;
...
SIGNAL \AllMpx|MpxUsingIf|oY~3_combout\ : std_logic;
SIGNAL \AllMpx|MpxUsingCase|Mux0~0_combout\ : std_logic;
SIGNAL \AllMpx|MpxUsingIf|ALT_INV_oY~0_combout\ : std_logic;
SIGNAL \AllMpx|MpxUsingIf|ALT_INV_oY~2_combout\ : std_logic;
SIGNAL \ALT_INV_GPIO_0[2]~input_o\ : std_logic;
SIGNAL \ALT_INV_GPIO_0[0]~input_o\ : std_logic;
SIGNAL \AllMpx|MpxUsingIf|ALT_INV_oY~1_combout\ : std_logic;
...
\AllMpx|MpxUsingIf|ALT_INV_oY~2_combout\ <= NOT \AllMpx|MpxUsingIf|oY~2_combout\;
\ALT_INV_GPIO_0[2]~input_o\ <= NOT \GPIO_0[2]~input_o\;
\ALT_INV_GPIO_0[0]~input_o\ <= NOT \GPIO_0[0]~input_o\;
\AllMpx|MpxUsingIf|ALT_INV_oY~1_combout\ <= NOT \AllMpx|MpxUsingIf|oY~1_combout\;
...
-- pragma translate_on
PORT MAP (
	i => \AllMpx|MpxUsingIf|oY~3_combout\,
	devoe => ww_devoe,
	o => ww_LEDR(0));
...
-- pragma translate_on
PORT MAP (
	i => \AllMpx|MpxUsingCase|Mux0~0_combout\,
	devoe => ww_devoe,
	o => ww_LEDR(1));
...
\AllMpx|MpxUsingIf|oY~2\ : cyclonev_lcell_comb
-- Equation(s):
-- \AllMpx|MpxUsingIf|oY~2_combout\ = ( \GPIO_0[12]~input_o\ & ( \GPIO_0[8]~input_o\ & ( (!\GPIO_0[13]~input_o\ & (\GPIO_0[9]~input_o\)) # (\GPIO_0[13]~input_o\ & ((\GPIO_0[11]~input_o\))) ) ) ) # ( !\GPIO_0[12]~input_o\ & ( \GPIO_0[8]~input_o\ & ( 
...
PORT MAP (
	...
	combout => \AllMpx|MpxUsingIf|oY~2_combout\);
...
\AllMpx|MpxUsingIf|oY~1\ : cyclonev_lcell_comb
-- Equation(s):
-- \AllMpx|MpxUsingIf|oY~1_combout\ = ( \GPIO_0[12]~input_o\ & ( \GPIO_0[6]~input_o\ & ( (!\GPIO_0[13]~input_o\ & (\GPIO_0[5]~input_o\)) # (\GPIO_0[13]~input_o\ & ((\GPIO_0[7]~input_o\))) ) ) ) # ( !\GPIO_0[12]~input_o\ & ( \GPIO_0[6]~input_o\ & ( 
-- (\GPIO_0[13]~input_o\) # (\GPIO_0[4]~input_o\) ) ) ) # ( \GPIO_0[12]~input_o\ & ( !\GPIO_0[6]~input_o\ & ( (!\GPIO_0[13]~input_o\ & (\GPIO_0[5]~input_o\)) # (\GPIO_0[13]~input_o\ & ((\GPIO_0[7]~input_o\))) ) ) ) # ( !\GPIO_0[12]~input_o\ & ( 
-- !\GPIO_0[6]~input_o\ & ( (\GPIO_0[4]~input_o\ & !\GPIO_0[13]~input_o\) ) ) )
...
-- pragma translate_on
PORT MAP (
	dataa => \ALT_INV_GPIO_0[5]~input_o\,
	datab => \ALT_INV_GPIO_0[4]~input_o\,
	datac => \ALT_INV_GPIO_0[13]~input_o\,
	datad => \ALT_INV_GPIO_0[7]~input_o\,
	datae => \ALT_INV_GPIO_0[12]~input_o\,
	dataf => \ALT_INV_GPIO_0[6]~input_o\,
	combout => \AllMpx|MpxUsingIf|oY~1_combout\);
...
-- Equation(s):
-- \AllMpx|MpxUsingIf|oY~0_combout\ = ( \GPIO_0[1]~input_o\ & ( \GPIO_0[3]~input_o\ & ( ((!\GPIO_0[13]~input_o\ & (\GPIO_0[0]~input_o\)) # (\GPIO_0[13]~input_o\ & ((\GPIO_0[2]~input_o\)))) # (\GPIO_0[12]~input_o\) ) ) ) # ( !\GPIO_0[1]~input_o\ & ( 
-- \GPIO_0[3]~input_o\ & ( (!\GPIO_0[13]~input_o\ & (\GPIO_0[0]~input_o\ & ((!\GPIO_0[12]~input_o\)))) # (\GPIO_0[13]~input_o\ & (((\GPIO_0[12]~input_o\) # (\GPIO_0[2]~input_o\)))) ) ) ) # ( \GPIO_0[1]~input_o\ & ( !\GPIO_0[3]~input_o\ & ( 
-- (!\GPIO_0[13]~input_o\ & (((\GPIO_0[12]~input_o\)) # (\GPIO_0[0]~input_o\))) # (\GPIO_0[13]~input_o\ & (((\GPIO_0[2]~input_o\ & !\GPIO_0[12]~input_o\)))) ) ) ) # ( !\GPIO_0[1]~input_o\ & ( !\GPIO_0[3]~input_o\ & ( (!\GPIO_0[12]~input_o\ & 
-- ((!\GPIO_0[13]~input_o\ & (\GPIO_0[0]~input_o\)) # (\GPIO_0[13]~input_o\ & ((\GPIO_0[2]~input_o\))))) ) ) )
...
-- pragma translate_on
PORT MAP (
	dataa => \ALT_INV_GPIO_0[0]~input_o\,
	datab => \ALT_INV_GPIO_0[2]~input_o\,
	datac => \ALT_INV_GPIO_0[13]~input_o\,
	datad => \ALT_INV_GPIO_0[12]~input_o\,
	datae => \ALT_INV_GPIO_0[1]~input_o\,
	dataf => \ALT_INV_GPIO_0[3]~input_o\,
	combout => \AllMpx|MpxUsingIf|oY~0_combout\);

-- Location: LABCELL_X55_Y1_N48
\AllMpx|MpxUsingIf|oY~3\ : cyclonev_lcell_comb
-- Equation(s):
-- \AllMpx|MpxUsingIf|oY~3_combout\ = ( \GPIO_0[11]~input_o\ & ( \AllMpx|MpxUsingIf|oY~0_combout\ & ( (!\GPIO_0[15]~input_o\ & (((!\GPIO_0[14]~input_o\) # (\AllMpx|MpxUsingIf|oY~1_combout\)))) # (\GPIO_0[15]~input_o\ & (((\GPIO_0[14]~input_o\)) # 
-- (\AllMpx|MpxUsingIf|oY~2_combout\))) ) ) ) # ( !\GPIO_0[11]~input_o\ & ( \AllMpx|MpxUsingIf|oY~0_combout\ & ( (!\GPIO_0[15]~input_o\ & (((!\GPIO_0[14]~input_o\) # (\AllMpx|MpxUsingIf|oY~1_combout\)))) # (\GPIO_0[15]~input_o\ & 
-- (\AllMpx|MpxUsingIf|oY~2_combout\ & (!\GPIO_0[14]~input_o\))) ) ) ) # ( \GPIO_0[11]~input_o\ & ( !\AllMpx|MpxUsingIf|oY~0_combout\ & ( (!\GPIO_0[15]~input_o\ & (((\GPIO_0[14]~input_o\ & \AllMpx|MpxUsingIf|oY~1_combout\)))) # (\GPIO_0[15]~input_o\ & 
-- (((\GPIO_0[14]~input_o\)) # (\AllMpx|MpxUsingIf|oY~2_combout\))) ) ) ) # ( !\GPIO_0[11]~input_o\ & ( !\AllMpx|MpxUsingIf|oY~0_combout\ & ( (!\GPIO_0[15]~input_o\ & (((\GPIO_0[14]~input_o\ & \AllMpx|MpxUsingIf|oY~1_combout\)))) # (\GPIO_0[15]~input_o\ & 
-- (\AllMpx|MpxUsingIf|oY~2_combout\ & (!\GPIO_0[14]~input_o\))) ) ) )
...
-- pragma translate_on
PORT MAP (
	dataa => \ALT_INV_GPIO_0[15]~input_o\,
	datab => \AllMpx|MpxUsingIf|ALT_INV_oY~2_combout\,
	datac => \ALT_INV_GPIO_0[14]~input_o\,
	datad => \AllMpx|MpxUsingIf|ALT_INV_oY~1_combout\,
	datae => \ALT_INV_GPIO_0[11]~input_o\,
	dataf => \AllMpx|MpxUsingIf|ALT_INV_oY~0_combout\,
	combout => \AllMpx|MpxUsingIf|oY~3_combout\);

-- Location: LABCELL_X55_Y1_N54
\AllMpx|MpxUsingCase|Mux0~0\ : cyclonev_lcell_comb
-- Equation(s):
-- \AllMpx|MpxUsingCase|Mux0~0_combout\ = ( \GPIO_0[15]~input_o\ & ( \AllMpx|MpxUsingIf|oY~0_combout\ & ( (\AllMpx|MpxUsingIf|oY~2_combout\ & !\GPIO_0[14]~input_o\) ) ) ) # ( !\GPIO_0[15]~input_o\ & ( \AllMpx|MpxUsingIf|oY~0_combout\ & ( 
-- (!\GPIO_0[14]~input_o\) # (\AllMpx|MpxUsingIf|oY~1_combout\) ) ) ) # ( \GPIO_0[15]~input_o\ & ( !\AllMpx|MpxUsingIf|oY~0_combout\ & ( (\AllMpx|MpxUsingIf|oY~2_combout\ & !\GPIO_0[14]~input_o\) ) ) ) # ( !\GPIO_0[15]~input_o\ & ( 
-- !\AllMpx|MpxUsingIf|oY~0_combout\ & ( (\GPIO_0[14]~input_o\ & \AllMpx|MpxUsingIf|oY~1_combout\) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000000001111001100000011000011110000111111110011000000110000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	datab => \AllMpx|MpxUsingIf|ALT_INV_oY~2_combout\,
	datac => \ALT_INV_GPIO_0[14]~input_o\,
	datad => \AllMpx|MpxUsingIf|ALT_INV_oY~1_combout\,
	datae => \ALT_INV_GPIO_0[15]~input_o\,
	dataf => \AllMpx|MpxUsingIf|ALT_INV_oY~0_combout\,
	combout => \AllMpx|MpxUsingCase|Mux0~0_combout\);
