...
-- Equation(s):
-- \EntityReactionGame|StrobeGen|Equal0~1_combout\ = ( !\EntityReactionGame|StrobeGen|Count\(7) & ( \EntityReactionGame|StrobeGen|Count\(8) & ( (\EntityReactionGame|StrobeGen|Count\(6) & (!\EntityReactionGame|StrobeGen|Count\(5) & 
-- \EntityReactionGame|StrobeGen|Count\(9))) ) ) )
...
-- pragma translate_on
PORT MAP (
	dataa => \EntityReactionGame|StrobeGen|ALT_INV_Count\(6),
	datab => \EntityReactionGame|StrobeGen|ALT_INV_Count\(5),
	datac => \EntityReactionGame|StrobeGen|ALT_INV_Count\(9),
	datae => \EntityReactionGame|StrobeGen|ALT_INV_Count\(7),
...
-- Equation(s):
-- \EntityReactionGame|StrobeGen|Equal0~2_combout\ = ( \EntityReactionGame|StrobeGen|Count\(3) & ( \EntityReactionGame|StrobeGen|Count\(0) & ( (\EntityReactionGame|StrobeGen|Count\(2) & \EntityReactionGame|StrobeGen|Count\(1)) ) ) )
...
PORT MAP (
	datab => \EntityReactionGame|StrobeGen|ALT_INV_Count\(2),
	datad => \EntityReactionGame|StrobeGen|ALT_INV_Count\(1),
	datae => \EntityReactionGame|StrobeGen|ALT_INV_Count\(3),
...
-- Equation(s):
-- \EntityReactionGame|StrobeGen|Equal0~0_combout\ = ( !\EntityReactionGame|StrobeGen|Count\(13) & ( !\EntityReactionGame|StrobeGen|Count\(11) & ( (\EntityReactionGame|StrobeGen|Count\(15) & (\EntityReactionGame|StrobeGen|Count\(14) & 
-- !\EntityReactionGame|StrobeGen|Count\(12))) ) ) )
...
-- pragma translate_on
PORT MAP (
	dataa => \EntityReactionGame|StrobeGen|ALT_INV_Count\(15),
	datab => \EntityReactionGame|StrobeGen|ALT_INV_Count\(14),
	datac => \EntityReactionGame|StrobeGen|ALT_INV_Count\(12),
	datae => \EntityReactionGame|StrobeGen|ALT_INV_Count\(13),
	dataf => \EntityReactionGame|StrobeGen|ALT_INV_Count\(11),
...
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000000000000111111110000110000000000000000000000110000001100",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
...
-- Equation(s):
-- \EntityReactionGame|EntityReactionFSM|State~15_combout\ = ( \EntityReactionGame|EntityReactionFSM|State~14_combout\ & ( (((\EntitySyncA|MightMetha\(2) & !\EntityReactionGame|EdgeDetectionA|SyncPrev~q\)) # 
...
PORT MAP (
	...
	datac => \EntityReactionGame|EntityReactionFSM|ALT_INV_State.Unlocked~q\,
	datad => \EntityReactionGame|EntityReactionFSM|ALT_INV_State.ShowResult~q\,
	dataf => \EntityReactionGame|EntityReactionFSM|ALT_INV_State~14_combout\,
...
-- Equation(s):
-- \EntityReactionGame|CounterLow|oCount~2_combout\ = ( !\EntityReactionGame|CounterLow|oCount\(2) & ( \EntityReactionGame|CounterLow|oCount\(1) & ( (\EntityReactionGame|EntityReactionFSM|State.Locked~q\ & ((!\EntityReactionGame|CounterLow|oCount\(4)) # 
-- (\EntityReactionGame|CounterLow|oCount\(3)))) ) ) ) # ( \EntityReactionGame|CounterLow|oCount\(2) & ( !\EntityReactionGame|CounterLow|oCount\(1) & ( \EntityReactionGame|EntityReactionFSM|State.Locked~q\ ) ) )
...
PORT MAP (
	...
	dataf => \EntityReactionGame|CounterLow|ALT_INV_oCount\(1),
...
-- Equation(s):
-- \EntityReactionGame|HexDecoderLow|Mux6~0_combout\ = ( \EntityReactionGame|CounterLow|oCount\(4) & ( (\EntityReactionGame|CounterLow|oCount\(1) & (!\EntityReactionGame|CounterLow|oCount\(3) $ (!\EntityReactionGame|CounterLow|oCount\(2)))) ) ) # ( 
-- !\EntityReactionGame|CounterLow|oCount\(4) & ( (!\EntityReactionGame|CounterLow|oCount\(2) & (!\EntityReactionGame|CounterLow|oCount\(3) $ (!\EntityReactionGame|CounterLow|oCount\(1)))) ) )
...
-- pragma translate_on
PORT MAP (
	dataa => \EntityReactionGame|CounterLow|ALT_INV_oCount\(3),
	datab => \EntityReactionGame|CounterLow|ALT_INV_oCount\(1),
...
-- Equation(s):
-- \EntityReactionGame|HexDecoderLow|Mux5~0_combout\ = ( \EntityReactionGame|CounterLow|oCount\(4) & ( (!\EntityReactionGame|CounterLow|oCount\(1) & (\EntityReactionGame|CounterLow|oCount\(3))) # (\EntityReactionGame|CounterLow|oCount\(1) & 
-- ((\EntityReactionGame|CounterLow|oCount\(2)))) ) ) # ( !\EntityReactionGame|CounterLow|oCount\(4) & ( (\EntityReactionGame|CounterLow|oCount\(3) & (!\EntityReactionGame|CounterLow|oCount\(2) $ (!\EntityReactionGame|CounterLow|oCount\(1)))) ) )
...
PORT MAP (
	dataa => \EntityReactionGame|CounterLow|ALT_INV_oCount\(3),
	datab => \EntityReactionGame|CounterLow|ALT_INV_oCount\(2),
	datac => \EntityReactionGame|CounterLow|ALT_INV_oCount\(1),
	dataf => \EntityReactionGame|CounterLow|ALT_INV_oCount\(4),
...
-- Equation(s):
-- \EntityReactionGame|HexDecoderLow|Mux4~0_combout\ = ( \EntityReactionGame|CounterLow|oCount\(4) & ( (\EntityReactionGame|CounterLow|oCount\(3) & ((!\EntityReactionGame|CounterLow|oCount\(1)) # (\EntityReactionGame|CounterLow|oCount\(2)))) ) ) # ( 
-- !\EntityReactionGame|CounterLow|oCount\(4) & ( (!\EntityReactionGame|CounterLow|oCount\(3) & (\EntityReactionGame|CounterLow|oCount\(2) & !\EntityReactionGame|CounterLow|oCount\(1))) ) )
...
-- Equation(s):
-- \EntityReactionGame|HexDecoderLow|Mux3~0_combout\ = ( \EntityReactionGame|CounterLow|oCount\(4) & ( (\EntityReactionGame|CounterLow|oCount\(2) & (!\EntityReactionGame|CounterLow|oCount\(3) $ (\EntityReactionGame|CounterLow|oCount\(1)))) ) ) # ( 
-- !\EntityReactionGame|CounterLow|oCount\(4) & ( (!\EntityReactionGame|CounterLow|oCount\(3) & (!\EntityReactionGame|CounterLow|oCount\(2) & \EntityReactionGame|CounterLow|oCount\(1))) # (\EntityReactionGame|CounterLow|oCount\(3) & 
-- (!\EntityReactionGame|CounterLow|oCount\(2) $ (\EntityReactionGame|CounterLow|oCount\(1)))) ) )
...
-- Equation(s):
-- \EntityReactionGame|HexDecoderLow|Mux2~0_combout\ = ( \EntityReactionGame|CounterLow|oCount\(4) & ( (!\EntityReactionGame|CounterLow|oCount\(3) & (!\EntityReactionGame|CounterLow|oCount\(2) & \EntityReactionGame|CounterLow|oCount\(1))) ) ) # ( 
-- !\EntityReactionGame|CounterLow|oCount\(4) & ( ((\EntityReactionGame|CounterLow|oCount\(3) & !\EntityReactionGame|CounterLow|oCount\(2))) # (\EntityReactionGame|CounterLow|oCount\(1)) ) )
...
-- Equation(s):
-- \EntityReactionGame|HexDecoderLow|Mux1~0_combout\ = ( \EntityReactionGame|CounterLow|oCount\(4) & ( (\EntityReactionGame|CounterLow|oCount\(3) & (!\EntityReactionGame|CounterLow|oCount\(2) & \EntityReactionGame|CounterLow|oCount\(1))) ) ) # ( 
-- !\EntityReactionGame|CounterLow|oCount\(4) & ( (!\EntityReactionGame|CounterLow|oCount\(3) & ((\EntityReactionGame|CounterLow|oCount\(1)) # (\EntityReactionGame|CounterLow|oCount\(2)))) # (\EntityReactionGame|CounterLow|oCount\(3) & 
-- (\EntityReactionGame|CounterLow|oCount\(2) & \EntityReactionGame|CounterLow|oCount\(1))) ) )
...
-- Equation(s):
-- \EntityReactionGame|HexDecoderLow|Mux0~0_combout\ = ( \EntityReactionGame|CounterLow|oCount\(4) & ( (!\EntityReactionGame|CounterLow|oCount\(3)) # ((\EntityReactionGame|CounterLow|oCount\(1)) # (\EntityReactionGame|CounterLow|oCount\(2))) ) ) # ( 
-- !\EntityReactionGame|CounterLow|oCount\(4) & ( (!\EntityReactionGame|CounterLow|oCount\(3) & (\EntityReactionGame|CounterLow|oCount\(2))) # (\EntityReactionGame|CounterLow|oCount\(3) & ((!\EntityReactionGame|CounterLow|oCount\(2)) # 
-- (!\EntityReactionGame|CounterLow|oCount\(1)))) ) )
...
-- pragma translate_on
PORT MAP (
	dataa => \EntityReactionGame|EntityReactionFSM|ALT_INV_State.Locked~q\,
...
-- Equation(s):
-- \EntityReactionGame|CounterLow|Equal0~0_combout\ = ( \EntityReactionGame|CounterLow|oCount\(1) & ( \EntityReactionGame|CounterLow|oCount\(4) & ( (!\EntityReactionGame|CounterLow|oCount\(2) & !\EntityReactionGame|CounterLow|oCount\(3)) ) ) )
...
PORT MAP (
	datab => \EntityReactionGame|CounterLow|ALT_INV_oCount\(2),
	datac => \EntityReactionGame|CounterLow|ALT_INV_oCount\(3),
	datae => \EntityReactionGame|CounterLow|ALT_INV_oCount\(1),
	dataf => \EntityReactionGame|CounterLow|ALT_INV_oCount\(4),
...
-- Equation(s):
-- \EntityReactionGame|CounterMid|oCount[4]~1_combout\ = ( \EntityReactionGame|StrobeGen|oStrobe~q\ & ( (!\EntityReactionGame|EntityReactionFSM|State.Locked~q\) # ((\EntityReactionGame|CounterLow|Equal0~0_combout\ & 
-- \EntityReactionGame|EntityReactionFSM|State.CountUpTime~q\)) ) ) # ( !\EntityReactionGame|StrobeGen|oStrobe~q\ & ( !\EntityReactionGame|EntityReactionFSM|State.Locked~q\ ) )
...
PORT MAP (
	dataa => \EntityReactionGame|EntityReactionFSM|ALT_INV_State.Locked~q\,
	datab => \EntityReactionGame|CounterLow|ALT_INV_Equal0~0_combout\,
	datac => \EntityReactionGame|EntityReactionFSM|ALT_INV_State.CountUpTime~q\,
	dataf => \EntityReactionGame|StrobeGen|ALT_INV_oStrobe~q\,
...
-- Equation(s):
-- \EntityReactionGame|CounterMid|oCount~4_combout\ = ( \EntityReactionGame|CounterMid|oCount\(4) & ( \EntityReactionGame|CounterMid|oCount\(3) & ( (\EntityReactionGame|EntityReactionFSM|State.Locked~q\ & ((!\EntityReactionGame|CounterMid|oCount\(2)) # 
-- (!\EntityReactionGame|CounterMid|oCount\(1)))) ) ) ) # ( !\EntityReactionGame|CounterMid|oCount\(4) & ( \EntityReactionGame|CounterMid|oCount\(3) & ( (\EntityReactionGame|EntityReactionFSM|State.Locked~q\ & (\EntityReactionGame|CounterMid|oCount\(2) & 
-- \EntityReactionGame|CounterMid|oCount\(1))) ) ) ) # ( \EntityReactionGame|CounterMid|oCount\(4) & ( !\EntityReactionGame|CounterMid|oCount\(3) & ( (\EntityReactionGame|EntityReactionFSM|State.Locked~q\ & ((!\EntityReactionGame|CounterMid|oCount\(1)) # 
-- (\EntityReactionGame|CounterMid|oCount\(2)))) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000000000000010101010000010100000000000001010101010101010000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \EntityReactionGame|EntityReactionFSM|ALT_INV_State.Locked~q\,
	...
	dataf => \EntityReactionGame|CounterMid|ALT_INV_oCount\(3),
...
-- Equation(s):
-- \EntityReactionGame|CounterMid|oCount~2_combout\ = ( !\EntityReactionGame|CounterMid|oCount\(2) & ( \EntityReactionGame|CounterMid|oCount\(1) & ( (\EntityReactionGame|EntityReactionFSM|State.Locked~q\ & ((!\EntityReactionGame|CounterMid|oCount\(4)) # 
-- (\EntityReactionGame|CounterMid|oCount\(3)))) ) ) ) # ( \EntityReactionGame|CounterMid|oCount\(2) & ( !\EntityReactionGame|CounterMid|oCount\(1) & ( \EntityReactionGame|EntityReactionFSM|State.Locked~q\ ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000000000000000011110000111100001010000011110000000000000000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \EntityReactionGame|CounterMid|ALT_INV_oCount\(4),
	datac => \EntityReactionGame|EntityReactionFSM|ALT_INV_State.Locked~q\,
	datad => \EntityReactionGame|CounterMid|ALT_INV_oCount\(3),
	datae => \EntityReactionGame|CounterMid|ALT_INV_oCount\(2),
	dataf => \EntityReactionGame|CounterMid|ALT_INV_oCount\(1),
...
-- Equation(s):
-- \EntityReactionGame|HexDecoderMid|Mux6~0_combout\ = ( \EntityReactionGame|CounterMid|oCount\(4) & ( (\EntityReactionGame|CounterMid|oCount\(1) & (!\EntityReactionGame|CounterMid|oCount\(3) $ (!\EntityReactionGame|CounterMid|oCount\(2)))) ) ) # ( 
-- !\EntityReactionGame|CounterMid|oCount\(4) & ( (!\EntityReactionGame|CounterMid|oCount\(2) & (!\EntityReactionGame|CounterMid|oCount\(3) $ (!\EntityReactionGame|CounterMid|oCount\(1)))) ) )
...
-- pragma translate_on
PORT MAP (
	datab => \EntityReactionGame|CounterMid|ALT_INV_oCount\(3),
	datac => \EntityReactionGame|CounterMid|ALT_INV_oCount\(2),
	datad => \EntityReactionGame|CounterMid|ALT_INV_oCount\(1),
...
-- Equation(s):
-- \EntityReactionGame|HexDecoderMid|Mux5~0_combout\ = ( \EntityReactionGame|CounterMid|oCount\(4) & ( (!\EntityReactionGame|CounterMid|oCount\(1) & ((\EntityReactionGame|CounterMid|oCount\(3)))) # (\EntityReactionGame|CounterMid|oCount\(1) & 
-- (\EntityReactionGame|CounterMid|oCount\(2))) ) ) # ( !\EntityReactionGame|CounterMid|oCount\(4) & ( (\EntityReactionGame|CounterMid|oCount\(3) & (!\EntityReactionGame|CounterMid|oCount\(1) $ (!\EntityReactionGame|CounterMid|oCount\(2)))) ) )
...
-- pragma translate_on
PORT MAP (
	dataa => \EntityReactionGame|CounterMid|ALT_INV_oCount\(1),
...
-- Equation(s):
-- \EntityReactionGame|HexDecoderMid|Mux4~0_combout\ = ( \EntityReactionGame|CounterMid|oCount\(4) & ( (\EntityReactionGame|CounterMid|oCount\(3) & ((!\EntityReactionGame|CounterMid|oCount\(1)) # (\EntityReactionGame|CounterMid|oCount\(2)))) ) ) # ( 
-- !\EntityReactionGame|CounterMid|oCount\(4) & ( (!\EntityReactionGame|CounterMid|oCount\(1) & (\EntityReactionGame|CounterMid|oCount\(2) & !\EntityReactionGame|CounterMid|oCount\(3))) ) )
...
-- Equation(s):
-- \EntityReactionGame|HexDecoderMid|Mux3~0_combout\ = ( \EntityReactionGame|CounterMid|oCount\(4) & ( (\EntityReactionGame|CounterMid|oCount\(2) & (!\EntityReactionGame|CounterMid|oCount\(1) $ (\EntityReactionGame|CounterMid|oCount\(3)))) ) ) # ( 
-- !\EntityReactionGame|CounterMid|oCount\(4) & ( (!\EntityReactionGame|CounterMid|oCount\(1) & (!\EntityReactionGame|CounterMid|oCount\(2) & \EntityReactionGame|CounterMid|oCount\(3))) # (\EntityReactionGame|CounterMid|oCount\(1) & 
-- (!\EntityReactionGame|CounterMid|oCount\(2) $ (\EntityReactionGame|CounterMid|oCount\(3)))) ) )
...
-- Equation(s):
-- \EntityReactionGame|HexDecoderMid|Mux2~0_combout\ = ( \EntityReactionGame|CounterMid|oCount\(3) & ( (!\EntityReactionGame|CounterMid|oCount\(4) & ((!\EntityReactionGame|CounterMid|oCount\(2)) # (\EntityReactionGame|CounterMid|oCount\(1)))) ) ) # ( 
-- !\EntityReactionGame|CounterMid|oCount\(3) & ( (\EntityReactionGame|CounterMid|oCount\(1) & ((!\EntityReactionGame|CounterMid|oCount\(2)) # (!\EntityReactionGame|CounterMid|oCount\(4)))) ) )
...
-- Equation(s):
-- \EntityReactionGame|HexDecoderMid|Mux1~0_combout\ = ( \EntityReactionGame|CounterMid|oCount\(4) & ( (\EntityReactionGame|CounterMid|oCount\(1) & (!\EntityReactionGame|CounterMid|oCount\(2) & \EntityReactionGame|CounterMid|oCount\(3))) ) ) # ( 
-- !\EntityReactionGame|CounterMid|oCount\(4) & ( (!\EntityReactionGame|CounterMid|oCount\(1) & (\EntityReactionGame|CounterMid|oCount\(2) & !\EntityReactionGame|CounterMid|oCount\(3))) # (\EntityReactionGame|CounterMid|oCount\(1) & 
-- ((!\EntityReactionGame|CounterMid|oCount\(3)) # (\EntityReactionGame|CounterMid|oCount\(2)))) ) )
...
-- Equation(s):
-- \EntityReactionGame|HexDecoderMid|Mux0~0_combout\ = ( \EntityReactionGame|CounterMid|oCount\(4) & ( ((!\EntityReactionGame|CounterMid|oCount\(3)) # (\EntityReactionGame|CounterMid|oCount\(2))) # (\EntityReactionGame|CounterMid|oCount\(1)) ) ) # ( 
-- !\EntityReactionGame|CounterMid|oCount\(4) & ( (!\EntityReactionGame|CounterMid|oCount\(2) & ((\EntityReactionGame|CounterMid|oCount\(3)))) # (\EntityReactionGame|CounterMid|oCount\(2) & ((!\EntityReactionGame|CounterMid|oCount\(1)) # 
...
-- Equation(s):
-- \EntityReactionGame|CounterMid|Equal0~0_combout\ = ( \EntityReactionGame|CounterMid|oCount\(4) & ( (\EntityReactionGame|CounterMid|oCount\(1) & (!\EntityReactionGame|CounterMid|oCount\(2) & !\EntityReactionGame|CounterMid|oCount\(3))) ) )
...
-- Equation(s):
-- \EntityReactionGame|CounterHigh|oCount[4]~1_combout\ = ( \EntityReactionGame|StrobeGen|oStrobe~q\ & ( (!\EntityReactionGame|EntityReactionFSM|State.Locked~q\) # ((\EntityReactionGame|CounterLow|Equal0~0_combout\ & 
-- (\EntityReactionGame|CounterMid|Equal0~0_combout\ & \EntityReactionGame|EntityReactionFSM|State.CountUpTime~q\))) ) ) # ( !\EntityReactionGame|StrobeGen|oStrobe~q\ & ( !\EntityReactionGame|EntityReactionFSM|State.Locked~q\ ) )
...
-- Equation(s):
-- \EntityReactionGame|CounterHigh|oCount~2_combout\ = ( !\EntityReactionGame|CounterHigh|oCount\(2) & ( \EntityReactionGame|CounterHigh|oCount\(1) & ( (\EntityReactionGame|EntityReactionFSM|State.Locked~q\ & ((!\EntityReactionGame|CounterHigh|oCount\(4)) # 
-- (\EntityReactionGame|CounterHigh|oCount\(3)))) ) ) ) # ( \EntityReactionGame|CounterHigh|oCount\(2) & ( !\EntityReactionGame|CounterHigh|oCount\(1) & ( \EntityReactionGame|EntityReactionFSM|State.Locked~q\ ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000000000000010101010101010101010101000001010000000000000000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \EntityReactionGame|EntityReactionFSM|ALT_INV_State.Locked~q\,
	datac => \EntityReactionGame|CounterHigh|ALT_INV_oCount\(3),
	datad => \EntityReactionGame|CounterHigh|ALT_INV_oCount\(4),
...
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000000000000010100000101010100000000000001010101010101010000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \EntityReactionGame|EntityReactionFSM|ALT_INV_State.Locked~q\,
...
-- Equation(s):
-- \EntityReactionGame|HexDecoderHigh|Mux6~0_combout\ = ( \EntityReactionGame|CounterHigh|oCount\(1) & ( (!\EntityReactionGame|CounterHigh|oCount\(4) & (!\EntityReactionGame|CounterHigh|oCount\(2) & !\EntityReactionGame|CounterHigh|oCount\(3))) # 
-- (\EntityReactionGame|CounterHigh|oCount\(4) & (!\EntityReactionGame|CounterHigh|oCount\(2) $ (!\EntityReactionGame|CounterHigh|oCount\(3)))) ) ) # ( !\EntityReactionGame|CounterHigh|oCount\(1) & ( (!\EntityReactionGame|CounterHigh|oCount\(4) & 
-- (!\EntityReactionGame|CounterHigh|oCount\(2) & \EntityReactionGame|CounterHigh|oCount\(3))) ) )
...
-- Equation(s):
-- \EntityReactionGame|HexDecoderHigh|Mux5~0_combout\ = ( \EntityReactionGame|CounterHigh|oCount\(1) & ( (!\EntityReactionGame|CounterHigh|oCount\(2) & (\EntityReactionGame|CounterHigh|oCount\(3) & !\EntityReactionGame|CounterHigh|oCount\(4))) # 
-- (\EntityReactionGame|CounterHigh|oCount\(2) & ((\EntityReactionGame|CounterHigh|oCount\(4)))) ) ) # ( !\EntityReactionGame|CounterHigh|oCount\(1) & ( (\EntityReactionGame|CounterHigh|oCount\(3) & ((\EntityReactionGame|CounterHigh|oCount\(4)) # 
...
-- pragma translate_on
PORT MAP (
	dataa => \EntityReactionGame|CounterHigh|ALT_INV_oCount\(3),
	datab => \EntityReactionGame|CounterHigh|ALT_INV_oCount\(2),
...
-- Equation(s):
-- \EntityReactionGame|HexDecoderHigh|Mux4~0_combout\ = ( \EntityReactionGame|CounterHigh|oCount\(1) & ( (\EntityReactionGame|CounterHigh|oCount\(4) & (\EntityReactionGame|CounterHigh|oCount\(2) & \EntityReactionGame|CounterHigh|oCount\(3))) ) ) # ( 
-- !\EntityReactionGame|CounterHigh|oCount\(1) & ( (!\EntityReactionGame|CounterHigh|oCount\(4) & (\EntityReactionGame|CounterHigh|oCount\(2) & !\EntityReactionGame|CounterHigh|oCount\(3))) # (\EntityReactionGame|CounterHigh|oCount\(4) & 
-- ((\EntityReactionGame|CounterHigh|oCount\(3)))) ) )
...
-- Equation(s):
-- \EntityReactionGame|HexDecoderHigh|Mux3~0_combout\ = ( \EntityReactionGame|CounterHigh|oCount\(1) & ( (!\EntityReactionGame|CounterHigh|oCount\(3) & (!\EntityReactionGame|CounterHigh|oCount\(2) & !\EntityReactionGame|CounterHigh|oCount\(4))) # 
-- (\EntityReactionGame|CounterHigh|oCount\(3) & (\EntityReactionGame|CounterHigh|oCount\(2))) ) ) # ( !\EntityReactionGame|CounterHigh|oCount\(1) & ( (!\EntityReactionGame|CounterHigh|oCount\(3) & (\EntityReactionGame|CounterHigh|oCount\(2) & 
-- \EntityReactionGame|CounterHigh|oCount\(4))) # (\EntityReactionGame|CounterHigh|oCount\(3) & (!\EntityReactionGame|CounterHigh|oCount\(2) & !\EntityReactionGame|CounterHigh|oCount\(4))) ) )
...
-- Equation(s):
-- \EntityReactionGame|HexDecoderHigh|Mux2~0_combout\ = ( \EntityReactionGame|CounterHigh|oCount\(2) & ( (!\EntityReactionGame|CounterHigh|oCount\(4) & \EntityReactionGame|CounterHigh|oCount\(1)) ) ) # ( !\EntityReactionGame|CounterHigh|oCount\(2) & ( 
-- (!\EntityReactionGame|CounterHigh|oCount\(3) & ((\EntityReactionGame|CounterHigh|oCount\(1)))) # (\EntityReactionGame|CounterHigh|oCount\(3) & (!\EntityReactionGame|CounterHigh|oCount\(4))) ) )
...
-- Equation(s):
-- \EntityReactionGame|HexDecoderHigh|Mux1~0_combout\ = ( \EntityReactionGame|CounterHigh|oCount\(4) & ( (!\EntityReactionGame|CounterHigh|oCount\(2) & (\EntityReactionGame|CounterHigh|oCount\(3) & \EntityReactionGame|CounterHigh|oCount\(1))) ) ) # ( 
-- !\EntityReactionGame|CounterHigh|oCount\(4) & ( (!\EntityReactionGame|CounterHigh|oCount\(2) & (!\EntityReactionGame|CounterHigh|oCount\(3) & \EntityReactionGame|CounterHigh|oCount\(1))) # (\EntityReactionGame|CounterHigh|oCount\(2) & 
-- ((!\EntityReactionGame|CounterHigh|oCount\(3)) # (\EntityReactionGame|CounterHigh|oCount\(1)))) ) )
...
PORT MAP (
	...
	datac => \EntityReactionGame|CounterHigh|ALT_INV_oCount\(3),
	datad => \EntityReactionGame|CounterHigh|ALT_INV_oCount\(1),
	dataf => \EntityReactionGame|CounterHigh|ALT_INV_oCount\(4),
...
-- Equation(s):
-- \EntityReactionGame|HexDecoderHigh|Mux0~0_combout\ = ( \EntityReactionGame|CounterHigh|oCount\(4) & ( (!\EntityReactionGame|CounterHigh|oCount\(3)) # ((\EntityReactionGame|CounterHigh|oCount\(1)) # (\EntityReactionGame|CounterHigh|oCount\(2))) ) ) # ( 
-- !\EntityReactionGame|CounterHigh|oCount\(4) & ( (!\EntityReactionGame|CounterHigh|oCount\(3) & (\EntityReactionGame|CounterHigh|oCount\(2))) # (\EntityReactionGame|CounterHigh|oCount\(3) & ((!\EntityReactionGame|CounterHigh|oCount\(2)) # 
-- (!\EntityReactionGame|CounterHigh|oCount\(1)))) ) )
