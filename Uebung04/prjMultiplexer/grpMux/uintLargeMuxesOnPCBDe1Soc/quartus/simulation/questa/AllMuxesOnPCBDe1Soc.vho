...
ENTITY 	AllMuxesOnPCBDe1Soc IS
	...
	SW : IN IEEE.STD_LOGIC_1164.std_ulogic_vector(7 DOWNTO 0);
...
-- Equation(s):
-- \AllMpx|MpxUniversal|Mux0~4_combout\ = ( !\KEY[1]~input_o\ & ( ((!\KEY[2]~input_o\ & ((!\KEY[0]~input_o\ & ((\SW[7]~input_o\))) # (\KEY[0]~input_o\ & (\SW[6]~input_o\)))) # (\KEY[2]~input_o\ & (((\KEY[0]~input_o\))))) ) ) # ( \KEY[1]~input_o\ & ( 
-- ((!\KEY[2]~input_o\ & ((!\KEY[0]~input_o\ & ((\SW[5]~input_o\))) # (\KEY[0]~input_o\ & (\SW[4]~input_o\)))) # (\KEY[2]~input_o\ & (((\KEY[0]~input_o\))))) ) )
...
-- Equation(s):
-- \AllMpx|MpxUniversal|Mux0~0_combout\ = ( !\KEY[1]~input_o\ & ( (!\KEY[2]~input_o\ & ((((\AllMpx|MpxUniversal|Mux0~4_combout\))))) # (\KEY[2]~input_o\ & ((!\AllMpx|MpxUniversal|Mux0~4_combout\ & (((\SW[3]~input_o\)))) # 
-- (\AllMpx|MpxUniversal|Mux0~4_combout\ & (\SW[2]~input_o\)))) ) ) # ( \KEY[1]~input_o\ & ( ((!\KEY[2]~input_o\ & (((\AllMpx|MpxUniversal|Mux0~4_combout\)))) # (\KEY[2]~input_o\ & ((!\AllMpx|MpxUniversal|Mux0~4_combout\ & (\SW[1]~input_o\)) # 
-- (\AllMpx|MpxUniversal|Mux0~4_combout\ & ((\SW[0]~input_o\)))))) ) )
...
PORT MAP (
	...
	datad => \AllMpx|MpxUniversal|ALT_INV_Mux0~4_combout\,
	datae => \ALT_INV_KEY[1]~input_o\,
