...
-- pragma translate_on
PORT MAP (
	i => \AllMpx|MpxUsingIf|ALT_INV_oY~0_combout\,
	devoe => ww_devoe,
	o => ww_LEDR(0));
...
-- Equation(s):
-- \AllMpx|MpxUsingIf|oY~0_combout\ = ( \KEY[1]~input_o\ & ( (\KEY[0]~input_o\) # (\SW~input_o\) ) ) # ( !\KEY[1]~input_o\ & ( (!\SW~input_o\ & \KEY[0]~input_o\) ) )
